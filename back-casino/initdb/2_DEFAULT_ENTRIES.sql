INSERT INTO players (id, name, description) VALUES (1, 'Informatique', 'Ouaiiis du code partout');
INSERT INTO players (id, name, description) VALUES (2, 'Construction', 'Beaucoup de béton et des poutres');
INSERT INTO players (id, name, description) VALUES (3, 'Aéronautique', 'Vive le vent');
INSERT INTO players (id, name, description) VALUES (4, 'Data', 'Trop cool plein de données à ordonner');
INSERT INTO players (id, name, description) VALUES (5, 'Energie & Environnement', 'On est full green');
INSERT INTO players (id, name, description) VALUES (6, 'Management', 'Des managers de qualité');
INSERT INTO players (id, name, description) VALUES (7, 'Santé', 'On connait tous les os et tous les muscles du corps humain');
INSERT INTO players (id, name, description) VALUES (8, 'Architecture durable', 'Objectif 0 carbone');
